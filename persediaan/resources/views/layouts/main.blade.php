...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <!-- Data Produk (collapsible) -->
      <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
  <ul class="navbar-nav" id="accordionSidenav">
    <!-- Data Produk -->
    <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="collapseLaporan" data-bs-parent="#accordionSidenav">
        <ul class="nav flex-column ms-4">
          <li class="nav-item"><a class="nav-link" href="#">Laporan Produk Masuk</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Laporan Produk Keluar</a></li>
        </ul>
      </div>
    </li>
      ...
      <li class="nav-item">
        <form method="POST" action="{{ route('logout') }}">
          ...
          <a href="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault(); this.closest('form').submit();">
            ...
            <span class="nav-link-text ms-1 text-danger fw-bold">Log Out</span>
          </a>
        </form>
      </li>
    </ul>
